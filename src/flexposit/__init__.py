"""FlexPosit: mixed-precision Posit quantization for LLMs, with matching hardware.
    ...
    state = flexposit.quantize(model, flexposit.FlexPositConfig(bits=4.5),
                               sensitivity="data/sensitivity/llama-2-7b.csv")
    print(flexposit.wikitext2_perplexity(model, tok))
"""

__version__ = "0.2.0"

from flexposit.api import FlexPositConfig, QuantState, load_state, quantize, save
...
__all__ = [
    "FlexPositConfig", "QuantState", "quantize", "save", "load_state",
